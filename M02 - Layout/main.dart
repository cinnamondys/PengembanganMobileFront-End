...
import 'package:case_study_latihan/profile/profile_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Flutter Demo Home Page (211110347 - Cindy Sintiya)'),
    );
  }
}
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            Image.asset('assets/logo.webp', width: 350),
            Image.network(
            ...
            // Image.network(
            //   'https://www.mikroskil.ac.id/img/mikroskil-logo-universitas.fa51bd02.webp',
            //   width: 200,
            // ),
            const Icon(
